...
test.skip('password field validation - min', () => {
    // README.md 파일을 참고하여 테스트를 작성해보세요.
});

test.skip('password field validation - max', () => {
    // README.md 파일을 참고하여 테스트를 작성해보세요.
});

test.skip('password field validation - invalid character', () => {
    // README.md 파일을 참고하여 테스트를 작성해보세요.
});
...
test.skip('password-confirm field validation - match', () => {
    const { getByPlaceholderText, getByText } = render(<App />);
